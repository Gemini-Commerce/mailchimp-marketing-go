...
type InlineResponse20013 struct {
	...
	AudienceActivity *InlineResponse20013AudienceActivity `json:"audience_activity,omitempty"`
	...
	ReportSummary *InlineResponse20013ReportSummary `json:"report_summary,omitempty"`
