...
/*
AccountExportApiService Get account export info
Get information about a specific account export.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param exportId The unique id for the account export.
 * @param optional nil or *AccountExportApiGetAccountExportIdOpts - Optional Parameters:
...
type AccountExportApiGetAccountExportIdOpts struct {
    Fields optional.Interface
    ExcludeFields optional.Interface
}

func (a *AccountExportApiService) GetAccountExportId(ctx context.Context, exportId string, localVarOptionals *AccountExportApiGetAccountExportIdOpts) (InlineResponse2002, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/account-exports/{export_id}"
