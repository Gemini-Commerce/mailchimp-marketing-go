 ...
 * @param optional nil or *GetAccountExportIdOpts - Optional Parameters:
...
type GetAccountExportIdOpts struct { 
	Fields optional.Interface
	ExcludeFields optional.Interface
}

func (a *AccountExportApiService) GetAccountExportId(ctx context.Context, exportId string, localVarOptionals *GetAccountExportIdOpts) (InlineResponse2001Exports, *http.Response, error) {
	var (
