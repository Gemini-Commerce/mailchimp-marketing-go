...
type InlineResponse20011 struct {
	...
	Audience *InlineResponse20011Audience `json:"audience,omitempty"`
	Budget *InlineResponse20011Budget `json:"budget,omitempty"`
	CanceledAt time.Time `json:"canceled_at,omitempty"`
	Channel *InlineResponse20011Channel `json:"channel,omitempty"`
	Content *InlineResponse20011Content `json:"content,omitempty"`
	CreateTime time.Time `json:"create_time,omitempty"`
	EmailSourceName string `json:"email_source_name,omitempty"`
	EndTime time.Time `json:"end_time,omitempty"`
	Feedback *InlineResponse20011Feedback `json:"feedback,omitempty"`
	...
	Site *InlineResponse20011Site `json:"site,omitempty"`
