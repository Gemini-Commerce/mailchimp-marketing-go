...
func (a *FacebookAdsApiService) GetAllFacebookAds(ctx context.Context, localVarOptionals *FacebookAdsApiGetAllFacebookAdsOpts) (InlineResponse20010, *http.Response, error) {
	var (
...
func (a *FacebookAdsApiService) GetFacebookAdsId(ctx context.Context, outreachId string, localVarOptionals *FacebookAdsApiGetFacebookAdsIdOpts) (InlineResponse20011, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
