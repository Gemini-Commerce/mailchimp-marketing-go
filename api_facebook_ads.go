 ...
 * @param optional nil or *GetAllFacebookAdsOpts - Optional Parameters:
...
type GetAllFacebookAdsOpts struct { 
...
func (a *FacebookAdsApiService) GetAllFacebookAds(ctx context.Context, localVarOptionals *GetAllFacebookAdsOpts) (InlineResponse2008, *http.Response, error) {
	var (
 ...
 * @param optional nil or *GetFacebookAdsIdOpts - Optional Parameters:
     * @param "Fields" (optional.Interface of []string) -  A comma-separated list of fields to return. Reference parameters of sub-objects with dot notation.
     * @param "ExcludeFields" (optional.Interface of []string) -  A comma-separated list of fields to exclude. Reference parameters of sub-objects with dot notation.
...
type GetFacebookAdsIdOpts struct { 
	Fields optional.Interface
	ExcludeFields optional.Interface
}

func (a *FacebookAdsApiService) GetFacebookAdsId(ctx context.Context, outreachId string, localVarOptionals *GetFacebookAdsIdOpts) (InlineResponse2009, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
