...
func (a *AuthorizedAppsApiService) GetAuthorizedApps(ctx context.Context, localVarOptionals *AuthorizedAppsApiGetAuthorizedAppsOpts) (InlineResponse2003, *http.Response, error) {
	var (
...
func (a *AuthorizedAppsApiService) GetAuthorizedAppsId(ctx context.Context, appId string, localVarOptionals *AuthorizedAppsApiGetAuthorizedAppsIdOpts) (InlineResponse2004, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
