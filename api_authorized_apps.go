 ...
 * @param optional nil or *GetAuthorizedAppsOpts - Optional Parameters:
...
type GetAuthorizedAppsOpts struct { 
...
func (a *AuthorizedAppsApiService) GetAuthorizedApps(ctx context.Context, localVarOptionals *GetAuthorizedAppsOpts) (InlineResponse2002, *http.Response, error) {
	var (
 ...
 * @param optional nil or *GetAuthorizedAppsIdOpts - Optional Parameters:
     * @param "Fields" (optional.Interface of []string) -  A comma-separated list of fields to return. Reference parameters of sub-objects with dot notation.
     * @param "ExcludeFields" (optional.Interface of []string) -  A comma-separated list of fields to exclude. Reference parameters of sub-objects with dot notation.
...
type GetAuthorizedAppsIdOpts struct { 
	Fields optional.Interface
	ExcludeFields optional.Interface
}

func (a *AuthorizedAppsApiService) GetAuthorizedAppsId(ctx context.Context, appId string, localVarOptionals *GetAuthorizedAppsIdOpts) (InlineResponse2002Apps, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
