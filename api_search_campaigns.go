 ...
 * @param optional nil or *GetSearchCampaignsOpts - Optional Parameters:
...
type GetSearchCampaignsOpts struct { 
	Fields optional.Interface
	ExcludeFields optional.Interface
}

func (a *SearchCampaignsApiService) GetSearchCampaigns(ctx context.Context, query string, localVarOptionals *GetSearchCampaignsOpts) (Campaigns, *http.Response, error) {
	var (
