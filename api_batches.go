 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetBatchesOpts - Optional Parameters:
...
func (a *BatchesApiService) GetBatches(ctx context.Context, localVarOptionals *GetBatchesOpts) (BatchOperations, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param batchId The unique id for the batch operation.
 * @param optional nil or *GetBatchesIdOpts - Optional Parameters:
     * @param "Fields" (optional.Interface of []string) -  A comma-separated list of fields to return. Reference parameters of sub-objects with dot notation.
     * @param "ExcludeFields" (optional.Interface of []string) -  A comma-separated list of fields to exclude. Reference parameters of sub-objects with dot notation.
...
type GetBatchesIdOpts struct { 
	Fields optional.Interface
	ExcludeFields optional.Interface
}

func (a *BatchesApiService) GetBatchesId(ctx context.Context, batchId string, localVarOptionals *GetBatchesIdOpts) (Batch, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
