 ...
 * @param optional nil or *GetActivityFeedChimpChatterOpts - Optional Parameters:
...
type GetActivityFeedChimpChatterOpts struct { 
	Count optional.Int32
	Offset optional.Int32
}

func (a *ActivityFeedApiService) GetActivityFeedChimpChatter(ctx context.Context, localVarOptionals *GetActivityFeedChimpChatterOpts) (InlineResponse200, *http.Response, error) {
	var (
