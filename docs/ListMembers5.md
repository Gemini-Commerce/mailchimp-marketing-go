...
**MergeFields** | [**map[string]interface{}**](interface{}.md) | An individual merge var and value for a member. | [optional] [default to null]
...
**Tags** | [**[]ListMembers1Tags**](List Members_1_tags.md) | The tags applied to this member. | [optional] [default to null]
