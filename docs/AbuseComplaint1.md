...
**ListId** | **string** | The unique id of the list for the abuse report. | [optional] [default to null]
...
**Date** | [**time.Time**](time.Time.md) | Date for the abuse report | [optional] [default to null]
