...
**Queue** | [**[]SubscriberInAutomationQueue3**](Subscriber in Automation Queue_3.md) | An array of objects, each representing a subscriber queue for an email in an Automation workflow. | [optional] [default to null]
