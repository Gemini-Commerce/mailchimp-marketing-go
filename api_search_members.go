 ...
 * @param optional nil or *GetSearchMembersOpts - Optional Parameters:
...
type GetSearchMembersOpts struct { 
	Fields optional.Interface
	ExcludeFields optional.Interface
	ListId optional.String
}

func (a *SearchMembersApiService) GetSearchMembers(ctx context.Context, query string, localVarOptionals *GetSearchMembersOpts) (Members, *http.Response, error) {
	var (
