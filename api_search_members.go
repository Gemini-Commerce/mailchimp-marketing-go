...
/*
SearchMembersApiService Search members
Search for list members. This search can be restricted to a specific list, or can be used to search across all lists in an account.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param query The search query used to filter results. Query should be a valid email, or a string representing a contact&#x27;s first or last name.
 * @param optional nil or *SearchMembersApiGetSearchMembersOpts - Optional Parameters:
...
type SearchMembersApiGetSearchMembersOpts struct {
    Fields optional.Interface
    ExcludeFields optional.Interface
    ListId optional.String
}

func (a *SearchMembersApiService) GetSearchMembers(ctx context.Context, query string, localVarOptionals *SearchMembersApiGetSearchMembersOpts) (Members, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/search-members"
