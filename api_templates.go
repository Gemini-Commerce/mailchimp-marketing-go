...
func (a *TemplatesApiService) GetTemplates(ctx context.Context, localVarOptionals *GetTemplatesOpts) (Templates, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param templateId The unique id for the template.
 * @param optional nil or *GetTemplatesIdOpts - Optional Parameters:
     * @param "Fields" (optional.Interface of []string) -  A comma-separated list of fields to return. Reference parameters of sub-objects with dot notation.
     * @param "ExcludeFields" (optional.Interface of []string) -  A comma-separated list of fields to exclude. Reference parameters of sub-objects with dot notation.
...
type GetTemplatesIdOpts struct { 
	Fields optional.Interface
	ExcludeFields optional.Interface
}

func (a *TemplatesApiService) GetTemplatesId(ctx context.Context, templateId string, localVarOptionals *GetTemplatesIdOpts) (TemplateInstance, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param templateId The unique id for the template.
 * @param optional nil or *GetTemplatesIdDefaultContentOpts - Optional Parameters:
     * @param "Fields" (optional.Interface of []string) -  A comma-separated list of fields to return. Reference parameters of sub-objects with dot notation.
     * @param "ExcludeFields" (optional.Interface of []string) -  A comma-separated list of fields to exclude. Reference parameters of sub-objects with dot notation.
...
type GetTemplatesIdDefaultContentOpts struct { 
	Fields optional.Interface
	ExcludeFields optional.Interface
}

func (a *TemplatesApiService) GetTemplatesIdDefaultContent(ctx context.Context, templateId string, localVarOptionals *GetTemplatesIdDefaultContentOpts) (TemplateDefaultContent, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
