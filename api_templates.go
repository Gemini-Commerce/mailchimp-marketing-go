...
func (a *TemplatesApiService) GetTemplatesId(ctx context.Context, templateId string, localVarOptionals *TemplatesApiGetTemplatesIdOpts) (TemplateInstance1, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue TemplateInstance1
	)
...
@return TemplateInstance1
*/
func (a *TemplatesApiService) PatchTemplatesId(ctx context.Context, body TemplateInstance2, templateId string) (TemplateInstance1, *http.Response, error) {
	var (
...
@return TemplateInstance1
*/
func (a *TemplatesApiService) PostTemplates(ctx context.Context, body TemplateInstance) (TemplateInstance1, *http.Response, error) {
	var (
