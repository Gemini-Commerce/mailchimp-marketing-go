 ...
 * @param optional nil or *GetRootOpts - Optional Parameters:
...
type GetRootOpts struct { 
	Fields optional.Interface
	ExcludeFields optional.Interface
}

func (a *RootApiService) GetRoot(ctx context.Context, localVarOptionals *GetRootOpts) (ApiRoot, *http.Response, error) {
	var (
