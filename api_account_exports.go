 ...
 * @param optional nil or *GetAccountExportsOpts - Optional Parameters:
...
type GetAccountExportsOpts struct { 
...
func (a *AccountExportsApiService) GetAccountExports(ctx context.Context, localVarOptionals *GetAccountExportsOpts) (InlineResponse2001, *http.Response, error) {
	var (
